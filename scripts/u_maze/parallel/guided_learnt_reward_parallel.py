...
torch.save(learnt_trajectories,'logs/'+args.dataset+'/learnt_behaviour/MSE/trajectories_3.pt')
...
print(values)
torch.save(values,'logs/'+args.dataset+'/learnt_behaviour/MSE/values_3.pt')
