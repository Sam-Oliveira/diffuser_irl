...
for t in range(max_steps):
    ...
    #if t == 0:
    #for time in range(330,384):
     #   cond[time]=np.tile(np.array(target_with_velocity),(num_envs,1))
    ...
    #for i in range(300-t,384):
    #    cond[i]= np.tile(np.array(target_with_velocity),(num_envs,1))
