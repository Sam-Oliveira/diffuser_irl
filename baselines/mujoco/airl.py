...
# This is the env with 18 obs. Dataset only has 100k obs, not 1M like for diffuser I believe
expert = load_policy(
    "ppo-huggingface",
...
# Now will see reward of dataset trajectories under the AIRL learnt reward model (for ERC calculation)
...
## policies are wrappers around a diffusion model and a value guide
